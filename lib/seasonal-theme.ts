...
const SUMMER_RECIPE: MilitaryBackgroundRecipe = {
  glowA: "rgba(92, 188, 190, 0.22)",
  glowB: "rgba(210, 178, 122, 0.2)",
  contour: "rgba(104, 184, 186, 0.16)",
  contourAccent: "rgba(220, 190, 136, 0.18)",
  grid: "rgba(104, 184, 186, 0.07)",
  stripe: "rgba(210, 178, 122, 0.16)",
  scan: "rgba(144, 210, 204, 0.06)",
  camoA: "rgba(34, 86, 92, 0.44)",
  camoB: "rgba(128, 106, 70, 0.3)",
...
const THEMES: Record<SeasonalThemeId, SeasonalThemeDefinition> = {
  ...
  summer: {
    ...
    palette: {
      red: "oklch(0.7 0.08 195)",
      green: "oklch(0.8 0.08 78)",
      gold: "oklch(0.82 0.09 82)",
      snow: "oklch(0.98 0.02 95)",
      primary: "oklch(0.7 0.08 195)",
      accent: "oklch(0.82 0.09 82)",
      ring: "oklch(0.7 0.08 195)",
      chart4: "oklch(0.74 0.08 185)",
      chart5: "oklch(0.8 0.08 72)",
    },
  },
  autumn: {
    id: "autumn",

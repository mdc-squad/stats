...
const WINTER_RECIPE: MilitaryBackgroundRecipe = {
  glowA: "rgba(112, 184, 238, 0.3)",
  glowB: "rgba(244, 250, 255, 0.24)",
  contour: "rgba(162, 210, 244, 0.26)",
  contourAccent: "rgba(248, 252, 255, 0.26)",
  grid: "rgba(162, 210, 244, 0.11)",
  stripe: "rgba(228, 244, 255, 0.24)",
  scan: "rgba(220, 240, 255, 0.09)",
...
const SPRING_RECIPE: MilitaryBackgroundRecipe = {
  glowA: "rgba(110, 214, 139, 0.28)",
  glowB: "rgba(238, 132, 190, 0.24)",
  contour: "rgba(142, 210, 154, 0.2)",
  contourAccent: "rgba(246, 172, 214, 0.2)",
  grid: "rgba(142, 210, 154, 0.09)",
  stripe: "rgba(238, 132, 190, 0.18)",
  scan: "rgba(180, 232, 166, 0.08)",
  camoA: "rgba(58, 112, 70, 0.52)",
  camoB: "rgba(156, 82, 128, 0.36)",
...
const SUMMER_RECIPE: MilitaryBackgroundRecipe = {
  glowA: "rgba(82, 216, 220, 0.28)",
  glowB: "rgba(226, 188, 118, 0.26)",
  contour: "rgba(104, 206, 208, 0.2)",
  contourAccent: "rgba(232, 198, 136, 0.22)",
  grid: "rgba(104, 206, 208, 0.09)",
  stripe: "rgba(226, 188, 118, 0.2)",
  scan: "rgba(144, 230, 224, 0.08)",
  camoA: "rgba(34, 104, 110, 0.48)",
  camoB: "rgba(154, 124, 72, 0.36)",
  camoC: "rgba(14, 32, 34, 0.86)",
  baseStart: "rgba(10, 36, 42, 0.94)",
  baseMid: "rgba(18, 42, 42, 0.9)",
  baseEnd: "rgba(30, 26, 18, 0.9)",
  overlayTop: "rgba(5, 16, 18, 0.42)",
  overlayMid: "rgba(6, 18, 18, 0.28)",
  overlayBottom: "rgba(8, 14, 14, 0.56)",
  opacity: 0.3,
}
...
const AUTUMN_RECIPE: MilitaryBackgroundRecipe = {
  glowA: "rgba(124, 28, 38, 0.3)",
  glowB: "rgba(230, 184, 72, 0.24)",
  contour: "rgba(150, 68, 58, 0.2)",
  contourAccent: "rgba(232, 194, 92, 0.2)",
  grid: "rgba(210, 164, 72, 0.08)",
  stripe: "rgba(124, 28, 38, 0.2)",
  scan: "rgba(232, 186, 88, 0.08)",
  camoA: "rgba(92, 26, 30, 0.54)",
  camoB: "rgba(154, 118, 42, 0.36)",
...
const THEMES: Record<SeasonalThemeId, SeasonalThemeDefinition> = {
  ...
  winter: {
    ...
    palette: {
      red: "oklch(0.7 0.12 235)",
      green: "oklch(0.78 0.08 220)",
      gold: "oklch(0.94 0.03 230)",
      snow: "oklch(0.97 0.02 250)",
      primary: "oklch(0.7 0.12 235)",
      accent: "oklch(0.94 0.03 230)",
      ring: "oklch(0.78 0.08 220)",
      chart4: "oklch(0.82 0.07 220)",
      chart5: "oklch(0.96 0.02 245)",
    },
  },
  spring: {
    id: "spring",
    ...
    palette: {
      red: "oklch(0.74 0.16 350)",
      green: "oklch(0.62 0.16 145)",
      gold: "oklch(0.82 0.12 345)",
      snow: "oklch(0.98 0.02 120)",
      primary: "oklch(0.62 0.16 145)",
      accent: "oklch(0.82 0.12 345)",
      ring: "oklch(0.74 0.16 350)",
      chart4: "oklch(0.72 0.13 150)",
      chart5: "oklch(0.78 0.13 345)",
    },
  },
  summer: {
    id: "summer",
    ...
    palette: {
      red: "oklch(0.74 0.12 195)",
      green: "oklch(0.82 0.11 78)",
      gold: "oklch(0.84 0.12 82)",
      snow: "oklch(0.98 0.02 95)",
      primary: "oklch(0.74 0.12 195)",
      accent: "oklch(0.84 0.12 82)",
      ring: "oklch(0.74 0.12 195)",
      chart4: "oklch(0.78 0.11 185)",
      chart5: "oklch(0.82 0.1 72)",
    },
  },
  autumn: {
    id: "autumn",

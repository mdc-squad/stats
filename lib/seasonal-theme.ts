...
const SUMMER_RECIPE: MilitaryBackgroundRecipe = {
  glowA: "rgba(72, 214, 220, 0.26)",
  glowB: "rgba(232, 188, 96, 0.24)",
  contour: "rgba(92, 206, 210, 0.2)",
  contourAccent: "rgba(236, 198, 118, 0.22)",
  grid: "rgba(92, 206, 210, 0.09)",
  stripe: "rgba(232, 188, 96, 0.18)",
  scan: "rgba(126, 226, 218, 0.08)",
  camoA: "rgba(28, 96, 104, 0.48)",
  camoB: "rgba(150, 116, 54, 0.34)",
...
const THEMES: Record<SeasonalThemeId, SeasonalThemeDefinition> = {
  ...
  summer: {
    ...
    palette: {
      red: "oklch(0.72 0.12 192)",
      green: "oklch(0.84 0.12 82)",
      gold: "oklch(0.86 0.13 84)",
      snow: "oklch(0.98 0.02 95)",
      primary: "oklch(0.72 0.12 192)",
      accent: "oklch(0.86 0.13 84)",
      ring: "oklch(0.72 0.12 192)",
      chart4: "oklch(0.76 0.11 185)",
      chart5: "oklch(0.84 0.11 76)",
    },
  },
  autumn: {
    id: "autumn",

...
const SUMMER_RECIPE: MilitaryBackgroundRecipe = {
  glowA: "rgba(246, 112, 88, 0.3)",
  glowB: "rgba(250, 194, 78, 0.28)",
  contour: "rgba(236, 126, 96, 0.2)",
  contourAccent: "rgba(252, 210, 104, 0.22)",
  grid: "rgba(246, 142, 104, 0.09)",
  stripe: "rgba(250, 176, 72, 0.2)",
  scan: "rgba(250, 202, 100, 0.08)",
  camoA: "rgba(118, 56, 42, 0.48)",
  camoB: "rgba(168, 106, 42, 0.38)",
  camoC: "rgba(34, 22, 18, 0.84)",
  baseStart: "rgba(44, 20, 18, 0.94)",
  baseMid: "rgba(48, 30, 18, 0.9)",
  baseEnd: "rgba(28, 20, 14, 0.9)",
  overlayTop: "rgba(18, 9, 7, 0.42)",
  overlayMid: "rgba(18, 10, 6, 0.28)",
  overlayBottom: "rgba(18, 9, 7, 0.56)",
  opacity: 0.3,
}
...
const THEMES: Record<SeasonalThemeId, SeasonalThemeDefinition> = {
  ...
  summer: {
    ...
    palette: {
      red: "oklch(0.67 0.18 35)",
      green: "oklch(0.78 0.15 75)",
      gold: "oklch(0.84 0.16 82)",
      snow: "oklch(0.98 0.02 70)",
      primary: "oklch(0.67 0.18 35)",
      accent: "oklch(0.84 0.16 82)",
      ring: "oklch(0.84 0.16 82)",
      chart4: "oklch(0.78 0.15 75)",
      chart5: "oklch(0.72 0.16 45)",
    },
  },
  autumn: {
    id: "autumn",

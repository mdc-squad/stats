...
const SPRING_RECIPE: MilitaryBackgroundRecipe = {
  glowA: "rgba(98, 198, 132, 0.24)",
  glowB: "rgba(232, 126, 174, 0.22)",
  contour: "rgba(116, 198, 142, 0.18)",
  contourAccent: "rgba(234, 150, 190, 0.2)",
  grid: "rgba(116, 198, 142, 0.08)",
  stripe: "rgba(232, 126, 174, 0.16)",
  scan: "rgba(150, 224, 164, 0.07)",
  camoA: "rgba(34, 88, 56, 0.5)",
  camoB: "rgba(132, 62, 104, 0.32)",
  camoC: "rgba(16, 34, 24, 0.86)",
  baseStart: "rgba(10, 34, 24, 0.95)",
  baseMid: "rgba(18, 42, 30, 0.92)",
  baseEnd: "rgba(36, 18, 34, 0.92)",
  overlayTop: "rgba(6, 16, 10, 0.44)",
  overlayMid: "rgba(8, 18, 12, 0.28)",
  overlayBottom: "rgba(8, 10, 14, 0.58)",
  opacity: 0.3,
}
...
const AUTUMN_RECIPE: MilitaryBackgroundRecipe = {
  glowA: "rgba(132, 32, 54, 0.27)",
  glowB: "rgba(228, 156, 56, 0.24)",
  contour: "rgba(154, 58, 64, 0.2)",
  contourAccent: "rgba(232, 164, 62, 0.22)",
  grid: "rgba(212, 130, 48, 0.08)",
  stripe: "rgba(132, 32, 54, 0.18)",
  scan: "rgba(230, 150, 58, 0.07)",
  camoA: "rgba(92, 24, 38, 0.52)",
  camoB: "rgba(138, 78, 26, 0.36)",
  camoC: "rgba(30, 12, 14, 0.88)",
  baseStart: "rgba(44, 10, 18, 0.96)",
  baseMid: "rgba(40, 18, 14, 0.92)",
  baseEnd: "rgba(26, 14, 8, 0.93)",
  overlayTop: "rgba(16, 4, 8, 0.48)",
  overlayMid: "rgba(14, 6, 5, 0.3)",
  overlayBottom: "rgba(14, 4, 6, 0.62)",
  opacity: 0.3,
}
...
const THEMES: Record<SeasonalThemeId, SeasonalThemeDefinition> = {
  ...
  spring: {
    ...
    palette: {
      red: "oklch(0.76 0.13 350)",
      green: "oklch(0.66 0.12 150)",
      gold: "oklch(0.82 0.11 345)",
      snow: "oklch(0.98 0.02 120)",
      primary: "oklch(0.66 0.12 150)",
      accent: "oklch(0.82 0.11 345)",
      ring: "oklch(0.76 0.13 350)",
      chart4: "oklch(0.7 0.1 155)",
      chart5: "oklch(0.8 0.1 340)",
    },
  },
  summer: {
    id: "summer",
  ...
  autumn: {
    ...
    palette: {
      red: "oklch(0.48 0.14 24)",
      green: "oklch(0.6 0.1 58)",
      gold: "oklch(0.8 0.13 76)",
      snow: "oklch(0.97 0.02 80)",
      primary: "oklch(0.48 0.14 24)",
      accent: "oklch(0.8 0.13 76)",
      ring: "oklch(0.8 0.13 76)",
      chart4: "oklch(0.64 0.1 54)",
      chart5: "oklch(0.54 0.13 24)",
    },
  },
}

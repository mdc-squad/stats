...
const SPRING_RECIPE: MilitaryBackgroundRecipe = {
  glowA: "rgba(126, 214, 150, 0.22)",
  glowB: "rgba(246, 158, 204, 0.24)",
  contour: "rgba(136, 210, 158, 0.17)",
  contourAccent: "rgba(246, 172, 212, 0.22)",
  grid: "rgba(136, 210, 158, 0.07)",
  stripe: "rgba(246, 158, 204, 0.16)",
  scan: "rgba(176, 232, 178, 0.06)",
  camoA: "rgba(42, 92, 58, 0.46)",
  camoB: "rgba(150, 78, 118, 0.3)",
  camoC: "rgba(18, 36, 26, 0.84)",
  baseStart: "rgba(12, 36, 26, 0.94)",
  baseMid: "rgba(18, 46, 34, 0.9)",
  baseEnd: "rgba(34, 22, 38, 0.9)",
  overlayTop: "rgba(6, 16, 10, 0.4)",
  overlayMid: "rgba(8, 18, 12, 0.24)",
  overlayBottom: "rgba(8, 10, 14, 0.54)",
  opacity: 0.3,
}
...
const AUTUMN_RECIPE: MilitaryBackgroundRecipe = {
  glowA: "rgba(104, 38, 82, 0.24)",
  glowB: "rgba(226, 154, 46, 0.27)",
  contour: "rgba(132, 74, 96, 0.18)",
  contourAccent: "rgba(236, 166, 62, 0.24)",
  grid: "rgba(218, 134, 48, 0.08)",
  stripe: "rgba(226, 154, 46, 0.18)",
  scan: "rgba(232, 158, 54, 0.07)",
  camoA: "rgba(68, 28, 56, 0.5)",
  camoB: "rgba(136, 76, 28, 0.36)",
  camoC: "rgba(24, 12, 22, 0.88)",
  baseStart: "rgba(28, 10, 26, 0.96)",
  baseMid: "rgba(34, 18, 24, 0.92)",
  baseEnd: "rgba(34, 18, 8, 0.93)",
  overlayTop: "rgba(10, 4, 10, 0.48)",
  overlayMid: "rgba(12, 6, 7, 0.3)",
  overlayBottom: "rgba(10, 4, 7, 0.62)",
  opacity: 0.3,
}
...
const THEMES: Record<SeasonalThemeId, SeasonalThemeDefinition> = {
  ...
  spring: {
    ...
    palette: {
      red: "oklch(0.78 0.12 348)",
      green: "oklch(0.7 0.11 148)",
      gold: "oklch(0.86 0.1 345)",
      snow: "oklch(0.98 0.02 120)",
      primary: "oklch(0.7 0.11 148)",
      accent: "oklch(0.86 0.1 345)",
      ring: "oklch(0.78 0.12 348)",
      chart4: "oklch(0.74 0.09 150)",
      chart5: "oklch(0.82 0.09 342)",
    },
  },
  summer: {
    id: "summer",
  ...
  autumn: {
    ...
    palette: {
      red: "oklch(0.46 0.12 335)",
      green: "oklch(0.62 0.1 58)",
      gold: "oklch(0.82 0.14 72)",
      snow: "oklch(0.97 0.02 80)",
      primary: "oklch(0.46 0.12 335)",
      accent: "oklch(0.82 0.14 72)",
      ring: "oklch(0.82 0.14 72)",
      chart4: "oklch(0.66 0.09 56)",
      chart5: "oklch(0.52 0.11 338)",
    },
  },
}

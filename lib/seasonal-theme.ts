...
const SUMMER_RECIPE: MilitaryBackgroundRecipe = {
  glowA: "rgba(54, 176, 198, 0.24)",
  glowB: "rgba(238, 132, 78, 0.24)",
  contour: "rgba(74, 168, 188, 0.18)",
  contourAccent: "rgba(238, 146, 88, 0.2)",
  grid: "rgba(74, 168, 188, 0.08)",
  stripe: "rgba(238, 146, 88, 0.16)",
  scan: "rgba(92, 198, 206, 0.07)",
  camoA: "rgba(22, 78, 94, 0.48)",
  camoB: "rgba(140, 72, 50, 0.34)",
  camoC: "rgba(14, 32, 34, 0.86)",
  baseStart: "rgba(10, 36, 42, 0.94)",
  baseMid: "rgba(16, 38, 42, 0.9)",
  baseEnd: "rgba(38, 24, 18, 0.9)",
...
const THEMES: Record<SeasonalThemeId, SeasonalThemeDefinition> = {
  ...
  summer: {
    ...
    palette: {
      red: "oklch(0.72 0.13 42)",
      green: "oklch(0.7 0.1 205)",
      gold: "oklch(0.84 0.12 78)",
      snow: "oklch(0.98 0.02 95)",
      primary: "oklch(0.72 0.13 42)",
      accent: "oklch(0.84 0.12 78)",
      ring: "oklch(0.7 0.1 205)",
      chart4: "oklch(0.74 0.1 198)",
      chart5: "oklch(0.76 0.11 38)",
    },
  },
  autumn: {
    id: "autumn",

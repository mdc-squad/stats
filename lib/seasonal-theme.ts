...
const SUMMER_RECIPE: MilitaryBackgroundRecipe = {
  glowA: "rgba(235, 78, 48, 0.3)",
  glowB: "rgba(248, 174, 64, 0.28)",
  contour: "rgba(224, 104, 62, 0.2)",
  contourAccent: "rgba(250, 194, 94, 0.22)",
  grid: "rgba(236, 124, 74, 0.09)",
  stripe: "rgba(248, 154, 62, 0.2)",
  scan: "rgba(248, 182, 92, 0.08)",
  camoA: "rgba(118, 48, 34, 0.5)",
  camoB: "rgba(164, 92, 40, 0.38)",
  camoC: "rgba(34, 22, 18, 0.84)",
  baseStart: "rgba(46, 18, 16, 0.94)",
  baseMid: "rgba(50, 28, 18, 0.9)",
  baseEnd: "rgba(28, 18, 14, 0.9)",
  overlayTop: "rgba(18, 8, 6, 0.42)",
  overlayMid: "rgba(18, 8, 6, 0.28)",
  overlayBottom: "rgba(18, 8, 6, 0.56)",
  opacity: 0.3,
}
...
const THEMES: Record<SeasonalThemeId, SeasonalThemeDefinition> = {
  ...
  summer: {
    ...
    palette: {
      ...
      green: "oklch(0.72 0.16 55)",
      gold: "oklch(0.78 0.17 65)",
      snow: "oklch(0.98 0.02 70)",
      primary: "oklch(0.62 0.21 30)",
      accent: "oklch(0.78 0.17 65)",
      ring: "oklch(0.78 0.17 65)",
      chart4: "oklch(0.72 0.16 55)",
      chart5: "oklch(0.68 0.18 38)",
    },
  },
  autumn: {
    id: "autumn",

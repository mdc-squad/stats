...
const SPRING_RECIPE: MilitaryBackgroundRecipe = {
  glowA: "rgba(92, 220, 178, 0.22)",
  glowB: "rgba(244, 146, 198, 0.24)",
  contour: "rgba(104, 214, 178, 0.17)",
  contourAccent: "rgba(244, 164, 206, 0.22)",
  grid: "rgba(104, 214, 178, 0.07)",
  stripe: "rgba(244, 146, 198, 0.15)",
  scan: "rgba(148, 230, 198, 0.06)",
  camoA: "rgba(24, 82, 64, 0.46)",
  camoB: "rgba(132, 66, 110, 0.3)",
  camoC: "rgba(12, 34, 28, 0.84)",
  baseStart: "rgba(8, 32, 28, 0.94)",
  baseMid: "rgba(12, 42, 34, 0.9)",
  baseEnd: "rgba(32, 18, 36, 0.9)",
  overlayTop: "rgba(4, 14, 12, 0.4)",
  overlayMid: "rgba(6, 18, 14, 0.24)",
  overlayBottom: "rgba(6, 9, 14, 0.54)",
  opacity: 0.3,
}
...
const THEMES: Record<SeasonalThemeId, SeasonalThemeDefinition> = {
  ...
  spring: {
    ...
    palette: {
      red: "oklch(0.78 0.12 342)",
      green: "oklch(0.72 0.1 168)",
      gold: "oklch(0.86 0.1 342)",
      snow: "oklch(0.98 0.02 120)",
      primary: "oklch(0.72 0.1 168)",
      accent: "oklch(0.86 0.1 342)",
      ring: "oklch(0.78 0.12 342)",
      chart4: "oklch(0.76 0.09 165)",
      chart5: "oklch(0.82 0.09 338)",
    },
  },
  summer: {
    id: "summer",

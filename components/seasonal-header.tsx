        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2 lg:flex-row lg:items-center">
            <button
              ...
              className={`group w-full rounded-2xl border px-3 py-2.5 text-left transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-christmas-gold/60 ${
                isPlaying
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0 flex flex-1 flex-col gap-1 md:flex-row md:items-center md:justify-between">
                  <div className="flex min-w-0 flex-wrap items-center gap-2 md:flex-nowrap">
                    ...
                    <span className="hidden text-christmas-gold/45 md:inline">•</span>
                    <p className="min-w-0 text-[13px] font-semibold leading-snug text-christmas-snow md:text-sm md:whitespace-nowrap">
                      {CLAN_MOTTO}
                    </p>
                  </div>
                  <span className="shrink-0 text-[11px] text-muted-foreground">
                    {isPlaying ? "loop" : "play / stop"}
                  </span>
                </div>
              </div>
            </button>
            ...
            {timeline?.celebrationLabel ? (
              <div className="inline-flex items-center gap-2 self-start rounded-full border border-christmas-red/25 bg-christmas-red/10 px-3 py-2 text-xs font-medium text-christmas-snow shadow-lg shadow-black/10 lg:self-auto">
                <Radio className="h-3.5 w-3.5 text-christmas-gold" />

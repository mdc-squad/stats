            ...
            <div className="min-w-0">
              ...
              <div className="mt-2 flex flex-col items-start gap-1.5">
                <button
                  ...
                  className={`group inline-flex max-w-full items-center gap-2 rounded-2xl border border-transparent px-0 py-0.5 text-left transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-christmas-gold/60 ${
                    isPlaying
                      ? "text-christmas-snow"
